...
plot(poly_a, main = expression('Spatial object'[1]))
plot(poly_b, main = expression('Spatial object'[2]))
```
  ...
  arrangeGrob(
    ggplot() +
      geom_sf(data = st_transform(poly_a[85,], crs = 4326), 
              fill = 'red', colour = 'red', alpha = .5) +
      labs(title = 'geography A1 (id = 85)'),
    ggplot() +
      geom_sf(data = st_transform(poly_b[60,], crs = 4326), 
              fill = 'blue', colour = 'blue', alpha = .5) +
      labs(title = 'geography B2 (id = 60)'),
    ncol = 2, nrow = 1),
  ggplot() +
    geom_sf(data = st_transform(poly_a[85,], crs = 4326), 
            fill = NA, colour = 'red', alpha = .5) +
  ...
  arrangeGrob(
    ggplot() +
      geom_sf(data = st_transform(poly_a[75,], crs = 4326), 
              fill = 'red', colour = 'red', alpha = .5) +
      labs(title = 'geography A1 (id = 75)'),
    ggplot() +
      geom_sf(data = st_transform(poly_b[94,], crs = 4326), 
              fill = 'blue', colour = 'blue', alpha = .5) +
      labs(title = 'geography B2 (id = 94)'),
    ncol = 2, nrow = 1),
  arrangeGrob(
    ggplot() +
      geom_sf(data = st_transform(poly_b[99,], crs = 4326), 
              fill = 'blue', colour = 'blue', alpha = .5) +
      labs(title = 'geography C2 (id = 99)'),
    ggplot() +
      geom_sf(data = st_transform(poly_b[105,], crs = 4326), 
              fill = 'blue', colour = 'blue', alpha = .5) +
      labs(title = 'geography D2 (id = 105)'),
    ncol = 2, nrow = 1),
  ggplot() +
    geom_sf(data = st_transform(poly_a[75,], crs = 4326), 
            fill = NA, colour = 'red', alpha = .5) +
